                        ...
                        @foreach ($tasks as $key=>$task)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-primary"><i class="fa-solid fa-pencil"  data-bs-toggle="modal" data-bs-target="#staticBackdrop">></i></a>
                                </td>
                            </tr>
                        @endforeach
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Todo update</h5>
